...
module Proto.OnnxMl
       (AttributeProto(..), AttributeProto'AttributeType(..),
        ...
        TypeProto'Value(..), _TypeProto'TensorType,
        _TypeProto'SequenceType, _TypeProto'MapType, TypeProto'Map(..),
        TypeProto'Sequence(..), TypeProto'Tensor(..), ValueInfoProto(..),
        Version(..), Version(), Version'UnrecognizedValue)
       where
...
{- | Fields :
    ...
    * 'Proto.OnnxMl_Fields.name' @:: Lens' AttributeProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.docString' @:: Lens' AttributeProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.type'' @:: Lens' AttributeProto AttributeProto'AttributeType@
    * 'Proto.OnnxMl_Fields.f' @:: Lens' AttributeProto Prelude.Float@
    * 'Proto.OnnxMl_Fields.i' @:: Lens' AttributeProto Data.Int.Int64@
    * 'Proto.OnnxMl_Fields.s' @:: Lens' AttributeProto Data.ByteString.ByteString@
    * 'Proto.OnnxMl_Fields.t' @:: Lens' AttributeProto TensorProto@
    * 'Proto.OnnxMl_Fields.maybe't' @:: Lens' AttributeProto (Prelude.Maybe TensorProto)@
    * 'Proto.OnnxMl_Fields.g' @:: Lens' AttributeProto GraphProto@
    * 'Proto.OnnxMl_Fields.maybe'g' @:: Lens' AttributeProto (Prelude.Maybe GraphProto)@
    * 'Proto.OnnxMl_Fields.floats' @:: Lens' AttributeProto [Prelude.Float]@
    * 'Proto.OnnxMl_Fields.ints' @:: Lens' AttributeProto [Data.Int.Int64]@
    * 'Proto.OnnxMl_Fields.strings' @:: Lens' AttributeProto [Data.ByteString.ByteString]@
    * 'Proto.OnnxMl_Fields.tensors' @:: Lens' AttributeProto [TensorProto]@
    * 'Proto.OnnxMl_Fields.graphs' @:: Lens' AttributeProto [GraphProto]@
 -}
...
{- | Fields :
    ...
    * 'Proto.OnnxMl_Fields.node' @:: Lens' GraphProto [NodeProto]@
    * 'Proto.OnnxMl_Fields.name' @:: Lens' GraphProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.initializer' @:: Lens' GraphProto [TensorProto]@
    * 'Proto.OnnxMl_Fields.docString' @:: Lens' GraphProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.input' @:: Lens' GraphProto [ValueInfoProto]@
    * 'Proto.OnnxMl_Fields.output' @:: Lens' GraphProto [ValueInfoProto]@
    * 'Proto.OnnxMl_Fields.valueInfo' @:: Lens' GraphProto [ValueInfoProto]@
 -}
...
{- | Fields :
    ...
    * 'Proto.OnnxMl_Fields.irVersion' @:: Lens' ModelProto Data.Int.Int64@
    * 'Proto.OnnxMl_Fields.opsetImport' @:: Lens' ModelProto [OperatorSetIdProto]@
    * 'Proto.OnnxMl_Fields.producerName' @:: Lens' ModelProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.producerVersion' @:: Lens' ModelProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.domain' @:: Lens' ModelProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.modelVersion' @:: Lens' ModelProto Data.Int.Int64@
    * 'Proto.OnnxMl_Fields.docString' @:: Lens' ModelProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.graph' @:: Lens' ModelProto GraphProto@
    * 'Proto.OnnxMl_Fields.maybe'graph' @:: Lens' ModelProto (Prelude.Maybe GraphProto)@
    * 'Proto.OnnxMl_Fields.metadataProps' @:: Lens' ModelProto [StringStringEntryProto]@
 -}
...
{- | Fields :
    ...
    * 'Proto.OnnxMl_Fields.input' @:: Lens' NodeProto [Data.Text.Text]@
    * 'Proto.OnnxMl_Fields.output' @:: Lens' NodeProto [Data.Text.Text]@
    * 'Proto.OnnxMl_Fields.name' @:: Lens' NodeProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.opType' @:: Lens' NodeProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.domain' @:: Lens' NodeProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.attribute' @:: Lens' NodeProto [AttributeProto]@
    * 'Proto.OnnxMl_Fields.docString' @:: Lens' NodeProto Data.Text.Text@
 -}
...
{- | Fields :
    ...
    * 'Proto.OnnxMl_Fields.domain' @:: Lens' OperatorSetIdProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.version' @:: Lens' OperatorSetIdProto Data.Int.Int64@
 -}
...
{- | Fields :
    ...
    * 'Proto.OnnxMl_Fields.key' @:: Lens' StringStringEntryProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.value' @:: Lens' StringStringEntryProto Data.Text.Text@
 -}
...
{- | Fields :
    ...
    * 'Proto.OnnxMl_Fields.dims' @:: Lens' TensorProto [Data.Int.Int64]@
    * 'Proto.OnnxMl_Fields.dataType' @:: Lens' TensorProto TensorProto'DataType@
    * 'Proto.OnnxMl_Fields.segment' @:: Lens' TensorProto TensorProto'Segment@
    * 'Proto.OnnxMl_Fields.maybe'segment' @:: Lens' TensorProto (Prelude.Maybe TensorProto'Segment)@
    * 'Proto.OnnxMl_Fields.floatData' @:: Lens' TensorProto [Prelude.Float]@
    * 'Proto.OnnxMl_Fields.int32Data' @:: Lens' TensorProto [Data.Int.Int32]@
    * 'Proto.OnnxMl_Fields.stringData' @:: Lens' TensorProto [Data.ByteString.ByteString]@
    * 'Proto.OnnxMl_Fields.int64Data' @:: Lens' TensorProto [Data.Int.Int64]@
    * 'Proto.OnnxMl_Fields.name' @:: Lens' TensorProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.docString' @:: Lens' TensorProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.rawData' @:: Lens' TensorProto Data.ByteString.ByteString@
    * 'Proto.OnnxMl_Fields.doubleData' @:: Lens' TensorProto [Prelude.Double]@
    * 'Proto.OnnxMl_Fields.uint64Data' @:: Lens' TensorProto [Data.Word.Word64]@
 -}
...
{- | Fields :
    ...
    * 'Proto.OnnxMl_Fields.begin' @:: Lens' TensorProto'Segment Data.Int.Int64@
    * 'Proto.OnnxMl_Fields.end' @:: Lens' TensorProto'Segment Data.Int.Int64@
 -}
...
{- | Fields :
    ...
    * 'Proto.OnnxMl_Fields.dim' @:: Lens' TensorShapeProto [TensorShapeProto'Dimension]@
 -}
...
{- | Fields :
    ...
    * 'Proto.OnnxMl_Fields.maybe'value' @:: Lens' TensorShapeProto'Dimension
  (Prelude.Maybe TensorShapeProto'Dimension'Value)@
    * 'Proto.OnnxMl_Fields.maybe'dimValue' @:: Lens' TensorShapeProto'Dimension (Prelude.Maybe Data.Int.Int64)@
    * 'Proto.OnnxMl_Fields.dimValue' @:: Lens' TensorShapeProto'Dimension Data.Int.Int64@
    * 'Proto.OnnxMl_Fields.maybe'dimParam' @:: Lens' TensorShapeProto'Dimension (Prelude.Maybe Data.Text.Text)@
    * 'Proto.OnnxMl_Fields.dimParam' @:: Lens' TensorShapeProto'Dimension Data.Text.Text@
 -}
...
{- | Fields :
    ...
    * 'Proto.OnnxMl_Fields.maybe'value' @:: Lens' TypeProto (Prelude.Maybe TypeProto'Value)@
    * 'Proto.OnnxMl_Fields.maybe'tensorType' @:: Lens' TypeProto (Prelude.Maybe TypeProto'Tensor)@
    * 'Proto.OnnxMl_Fields.tensorType' @:: Lens' TypeProto TypeProto'Tensor@
    * 'Proto.OnnxMl_Fields.maybe'sequenceType' @:: Lens' TypeProto (Prelude.Maybe TypeProto'Sequence)@
    * 'Proto.OnnxMl_Fields.sequenceType' @:: Lens' TypeProto TypeProto'Sequence@
    * 'Proto.OnnxMl_Fields.maybe'mapType' @:: Lens' TypeProto (Prelude.Maybe TypeProto'Map)@
    * 'Proto.OnnxMl_Fields.mapType' @:: Lens' TypeProto TypeProto'Map@
 -}
...
data TypeProto'Value = TypeProto'TensorType !TypeProto'Tensor
                     | TypeProto'SequenceType !TypeProto'Sequence
                     | TypeProto'MapType !TypeProto'Map
                     deriving (Prelude.Show, Prelude.Eq, Prelude.Ord)
        ...
        lensOf' _
          = (Prelude..)
              ...
              ((Prelude..)
                 ...
                 (Data.ProtoLens.maybeLens Data.Default.Class.def))
instance Prelude.Functor f =>
         Lens.Labels.HasLens' f TypeProto "maybe'sequenceType"
           (Prelude.Maybe TypeProto'Sequence)
         where
        lensOf' _
          = (Prelude..)
              (Lens.Family2.Unchecked.lens _TypeProto'value
              ...
              (Lens.Family2.Unchecked.lens
                 (\ x__ ->
                    case x__ of
                        Prelude.Just (TypeProto'SequenceType x__val) -> Prelude.Just x__val
                        _otherwise -> Prelude.Nothing)
                 (\ _ y__ -> Prelude.fmap TypeProto'SequenceType y__))
instance Prelude.Functor f =>
         Lens.Labels.HasLens' f TypeProto "sequenceType"
           (TypeProto'Sequence)
         where
        lensOf' _
          = (Prelude..)
              ...
              ((Prelude..)
                 ...
                 (Data.ProtoLens.maybeLens Data.Default.Class.def))
instance Prelude.Functor f =>
         Lens.Labels.HasLens' f TypeProto "maybe'mapType"
           (Prelude.Maybe TypeProto'Map)
         where
        lensOf' _
          = (Prelude..)
              (Lens.Family2.Unchecked.lens _TypeProto'value
              ...
              (Lens.Family2.Unchecked.lens
                 (\ x__ ->
                    case x__ of
                        Prelude.Just (TypeProto'MapType x__val) -> Prelude.Just x__val
                        _otherwise -> Prelude.Nothing)
                 (\ _ y__ -> Prelude.fmap TypeProto'MapType y__))
instance Prelude.Functor f =>
         Lens.Labels.HasLens' f TypeProto "mapType" (TypeProto'Map)
         where
        lensOf' _
          = (Prelude..)
              (Lens.Family2.Unchecked.lens _TypeProto'value
...
instance Data.ProtoLens.Message TypeProto where
        ...
        fieldsByTag
          = let tensorType__field_descriptor
                ...
                sequenceType__field_descriptor
                  = Data.ProtoLens.FieldDescriptor "sequence_type"
                      (Data.ProtoLens.MessageField Data.ProtoLens.MessageType ::
                         Data.ProtoLens.FieldTypeDescriptor TypeProto'Sequence)
                      (Data.ProtoLens.OptionalField
                         (Lens.Labels.lensOf
                            ((Lens.Labels.proxy#) ::
                               (Lens.Labels.Proxy#) "maybe'sequenceType")))
                      :: Data.ProtoLens.FieldDescriptor TypeProto
                mapType__field_descriptor
                  = Data.ProtoLens.FieldDescriptor "map_type"
                      (Data.ProtoLens.MessageField Data.ProtoLens.MessageType ::
                         Data.ProtoLens.FieldTypeDescriptor TypeProto'Map)
                      (Data.ProtoLens.OptionalField
                         (Lens.Labels.lensOf
              ...
              Data.Map.fromList
                [(Data.ProtoLens.Tag 1, tensorType__field_descriptor),
                 (Data.ProtoLens.Tag 4, sequenceType__field_descriptor),
                 (Data.ProtoLens.Tag 5, mapType__field_descriptor)]
        unknownFields
  ...
  = Lens.Labels.Prism.prism' TypeProto'TensorType
      (\ p__ ->
         case p__ of
             ...
             _otherwise -> Prelude.Nothing)
_TypeProto'SequenceType ::
                        Lens.Labels.Prism.Prism' TypeProto'Value TypeProto'Sequence
_TypeProto'SequenceType
  = Lens.Labels.Prism.prism' TypeProto'SequenceType
      (\ p__ ->
         case p__ of
             TypeProto'SequenceType p__val -> Prelude.Just p__val
             _otherwise -> Prelude.Nothing)
_TypeProto'MapType ::
                   Lens.Labels.Prism.Prism' TypeProto'Value TypeProto'Map
_TypeProto'MapType
  = Lens.Labels.Prism.prism' TypeProto'MapType
      (\ p__ ->
         case p__ of
             TypeProto'MapType p__val -> Prelude.Just p__val
             _otherwise -> Prelude.Nothing)
{- | Fields :

    * 'Proto.OnnxMl_Fields.keyType' @:: Lens' TypeProto'Map TensorProto'DataType@
    * 'Proto.OnnxMl_Fields.valueType' @:: Lens' TypeProto'Map TypeProto@
    * 'Proto.OnnxMl_Fields.maybe'valueType' @:: Lens' TypeProto'Map (Prelude.Maybe TypeProto)@
 -}
data TypeProto'Map = TypeProto'Map{_TypeProto'Map'keyType ::
                                   !TensorProto'DataType,
                                   _TypeProto'Map'valueType :: !(Prelude.Maybe TypeProto),
                                   _TypeProto'Map'_unknownFields :: !Data.ProtoLens.FieldSet}
                   deriving (Prelude.Show, Prelude.Eq, Prelude.Ord)
instance (Lens.Labels.HasLens' f TypeProto'Map x a, a ~ b) =>
         Lens.Labels.HasLens f TypeProto'Map TypeProto'Map x a b
         where
        lensOf = Lens.Labels.lensOf'
instance Prelude.Functor f =>
         Lens.Labels.HasLens' f TypeProto'Map "keyType"
           (TensorProto'DataType)
         where
        lensOf' _
          = (Prelude..)
              (Lens.Family2.Unchecked.lens _TypeProto'Map'keyType
                 (\ x__ y__ -> x__{_TypeProto'Map'keyType = y__}))
              Prelude.id
instance Prelude.Functor f =>
         Lens.Labels.HasLens' f TypeProto'Map "valueType" (TypeProto)
         where
        lensOf' _
          = (Prelude..)
              (Lens.Family2.Unchecked.lens _TypeProto'Map'valueType
                 (\ x__ y__ -> x__{_TypeProto'Map'valueType = y__}))
              (Data.ProtoLens.maybeLens Data.Default.Class.def)
instance Prelude.Functor f =>
         Lens.Labels.HasLens' f TypeProto'Map "maybe'valueType"
        ...
        lensOf' _
          = (Prelude..)
              (Lens.Family2.Unchecked.lens _TypeProto'Map'valueType
                 (\ x__ y__ -> x__{_TypeProto'Map'valueType = y__}))
              Prelude.id
instance Data.Default.Class.Default TypeProto'Map where
        def
          = TypeProto'Map{_TypeProto'Map'keyType = Data.Default.Class.def,
                          _TypeProto'Map'valueType = Prelude.Nothing,
                          _TypeProto'Map'_unknownFields = ([])}
instance Data.ProtoLens.Message TypeProto'Map where
        messageName _ = Data.Text.pack "onnx.TypeProto.Map"
        fieldsByTag
          = let keyType__field_descriptor
                  = Data.ProtoLens.FieldDescriptor "key_type"
                      (Data.ProtoLens.ScalarField Data.ProtoLens.EnumField ::
                         Data.ProtoLens.FieldTypeDescriptor TensorProto'DataType)
                      (Data.ProtoLens.PlainField Data.ProtoLens.Optional
                         (Lens.Labels.lensOf
                            ((Lens.Labels.proxy#) :: (Lens.Labels.Proxy#) "keyType")))
                      :: Data.ProtoLens.FieldDescriptor TypeProto'Map
        ...
        unknownFields
          = Lens.Family2.Unchecked.lens _TypeProto'Map'_unknownFields
              (\ x__ y__ -> x__{_TypeProto'Map'_unknownFields = y__})
{- | Fields :

    * 'Proto.OnnxMl_Fields.elemType' @:: Lens' TypeProto'Sequence TypeProto@
    * 'Proto.OnnxMl_Fields.maybe'elemType' @:: Lens' TypeProto'Sequence (Prelude.Maybe TypeProto)@
 -}
data TypeProto'Sequence = TypeProto'Sequence{_TypeProto'Sequence'elemType
                                             :: !(Prelude.Maybe TypeProto),
                                             _TypeProto'Sequence'_unknownFields ::
                                             !Data.ProtoLens.FieldSet}
                        deriving (Prelude.Show, Prelude.Eq, Prelude.Ord)
instance (Lens.Labels.HasLens' f TypeProto'Sequence x a, a ~ b) =>
         Lens.Labels.HasLens f TypeProto'Sequence TypeProto'Sequence x a b
         where
        lensOf = Lens.Labels.lensOf'
instance Prelude.Functor f =>
         Lens.Labels.HasLens' f TypeProto'Sequence "elemType" (TypeProto)
         where
        lensOf' _
          = (Prelude..)
              (Lens.Family2.Unchecked.lens _TypeProto'Sequence'elemType
                 (\ x__ y__ -> x__{_TypeProto'Sequence'elemType = y__}))
              (Data.ProtoLens.maybeLens Data.Default.Class.def)
instance Prelude.Functor f =>
         Lens.Labels.HasLens' f TypeProto'Sequence "maybe'elemType"
           (Prelude.Maybe TypeProto)
         where
        lensOf' _
          = (Prelude..)
              (Lens.Family2.Unchecked.lens _TypeProto'Sequence'elemType
                 (\ x__ y__ -> x__{_TypeProto'Sequence'elemType = y__}))
              Prelude.id
instance Data.Default.Class.Default TypeProto'Sequence where
        def
          = TypeProto'Sequence{_TypeProto'Sequence'elemType =
                                 Prelude.Nothing,
                               _TypeProto'Sequence'_unknownFields = ([])}
instance Data.ProtoLens.Message TypeProto'Sequence where
        messageName _ = Data.Text.pack "onnx.TypeProto.Sequence"
        fieldsByTag
          = let elemType__field_descriptor
                  = Data.ProtoLens.FieldDescriptor "elem_type"
                      ...
                      :: Data.ProtoLens.FieldDescriptor TypeProto'Sequence
              in
              Data.Map.fromList
                [(Data.ProtoLens.Tag 1, elemType__field_descriptor)]
        unknownFields
          = Lens.Family2.Unchecked.lens _TypeProto'Sequence'_unknownFields
              (\ x__ y__ -> x__{_TypeProto'Sequence'_unknownFields = y__})
{- | Fields :

    * 'Proto.OnnxMl_Fields.elemType' @:: Lens' TypeProto'Tensor TensorProto'DataType@
    * 'Proto.OnnxMl_Fields.shape' @:: Lens' TypeProto'Tensor TensorShapeProto@
    * 'Proto.OnnxMl_Fields.maybe'shape' @:: Lens' TypeProto'Tensor (Prelude.Maybe TensorShapeProto)@
 -}
...
{- | Fields :
    ...
    * 'Proto.OnnxMl_Fields.name' @:: Lens' ValueInfoProto Data.Text.Text@
    * 'Proto.OnnxMl_Fields.type'' @:: Lens' ValueInfoProto TypeProto@
    * 'Proto.OnnxMl_Fields.maybe'type'' @:: Lens' ValueInfoProto (Prelude.Maybe TypeProto)@
    * 'Proto.OnnxMl_Fields.docString' @:: Lens' ValueInfoProto Data.Text.Text@
 -}
