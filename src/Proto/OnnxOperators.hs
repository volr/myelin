...
{- | Fields :
    ...
    * 'Proto.OnnxOperators_Fields.opType' @:: Lens' OperatorProto Data.Text.Text@
    * 'Proto.OnnxOperators_Fields.sinceVersion' @:: Lens' OperatorProto Data.Int.Int64@
    * 'Proto.OnnxOperators_Fields.status' @:: Lens' OperatorProto OperatorProto'OperatorStatus@
    * 'Proto.OnnxOperators_Fields.docString' @:: Lens' OperatorProto Data.Text.Text@
 -}
...
{- | Fields :
    ...
    * 'Proto.OnnxOperators_Fields.magic' @:: Lens' OperatorSetProto Data.Text.Text@
    * 'Proto.OnnxOperators_Fields.irVersion' @:: Lens' OperatorSetProto Data.Int.Int32@
    * 'Proto.OnnxOperators_Fields.irVersionPrerelease' @:: Lens' OperatorSetProto Data.Text.Text@
    * 'Proto.OnnxOperators_Fields.irBuildMetadata' @:: Lens' OperatorSetProto Data.Text.Text@
    * 'Proto.OnnxOperators_Fields.domain' @:: Lens' OperatorSetProto Data.Text.Text@
    * 'Proto.OnnxOperators_Fields.opsetVersion' @:: Lens' OperatorSetProto Data.Int.Int64@
    * 'Proto.OnnxOperators_Fields.docString' @:: Lens' OperatorSetProto Data.Text.Text@
    * 'Proto.OnnxOperators_Fields.operator' @:: Lens' OperatorSetProto [OperatorProto]@
 -}
